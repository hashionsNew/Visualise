...
function library.create()
    ...
    function tab_module.create_tab(name: string)
        ...
        local tab = game:GetObjects('15868301328')[1]
        tab.name.TextLabel = name
        tab.Parent = main.container.hold.tabs

        local left_section = game:GetObjects('15868347492')[1]
        left_section.Parent = sections_folder

        local middle_section = game:GetObjects('15868353701')[1]
        middle_section.Parent = sections_folder

        local right_section = game:GetObjects('15868355337')[1]
